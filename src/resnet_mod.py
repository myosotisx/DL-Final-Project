...
class ResizeMapBlock(nn.Module):

    def __init__(self, ratios, channels, num_classes, conv_shape):
        super(ResizeMapBlock, self).__init__()
        self.paths_num = len(channels)
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    model = ResNetMod(block, layers, **kwargs)
    if pretrained:
